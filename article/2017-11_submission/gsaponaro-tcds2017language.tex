...
On the other hand, social robots still have a way to go in that regard, because of the difficulty of interpreting the unstructured world TODO COMPLETE
%Cognitive robots operating in unstructured environments

A humanoid robot can generalize its previously-acquired knowledge of
the world (objects, actions, effects, verbal descriptions) to the
cases when it observes a human agent performing familiar
actions in a shared \hr{} environment.

We propose a probabilistic method to fuse self-learned knowledge with the observation of other human agents.
We report results about how our model is able to learn and do inference from these two sources of information, as well as generating verbal descriptions of \hr{} collaboration scenarios with manipulative actions.
\end{abstract}
