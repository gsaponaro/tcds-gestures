...
\begin{table}
    \centering
    \caption{10-best sentences generated from the evidence~\eqref{eq:evidence_example}.}
...
\begin{figure*}
    ...
    \resizebox{!}{0.07\linewidth}{% https://tex.stackexchange.com/a/27105/18819
    \begin{tabular}{ll}
    \toprule
    sentence & score \\
    \midrule
...
%
%    \centering
    \caption{5-best sentences generated given two different sets of evidence. In (a) the model interprets the object movement as indicating a succesfull grasp and uses the conjunction ``and''. In (b) the slow movement is interpreted as no movement at all, and, therefore, as an unsuccessfull grasp. The conjunction ``but'' is used consequently.}
