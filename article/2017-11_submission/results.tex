...
\begin{figure*}
  ...
  \caption{Object velocity predictions before impact. The evidence from the action recognized (left) is fed into the affodance-word model before the end of the action. The combined model is able to predict the effect and to describe it in words (right).}
