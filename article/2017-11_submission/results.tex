...
\begin{table*}
    \centering
    \caption{Top sentences generated from the evidence~$\xobs^\prime$ of~\eqref{eq:evidence_producing_and}. The ``and'' conjunction was chosen in all of them. Intuitively, the model has learned that a grasping action which produces a significant movement is successful.}
...
\begin{table*}
    \centering
    \caption{Top sentences generated from the evidence~$\xobs''$ of~\eqref{eq:evidence_producing_but}. The ``but'' conjunction was chosen in all of them. Intuitively, the model has learned that a grasping action which produces no movement is a failure.}
