...
\subsection{FROM GLU - Prediction of Words from Hard Evidence - REMOVE OR TRIM}
\label{sec:results:pword_hard_evidence}
...
\subsection{Prediction from Soft Evidence}
...
TODO comment Fig.~\ref{fig:impact_of_evidence_on_Action}
