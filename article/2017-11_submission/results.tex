...
\begin{table*}
    \centering
    \caption{Top sentences generated from the evidence \emph{\{\evidenceProducingAnd\}}. The ``and'' conjunction was chosen in all of them. Intuitively, the model has learned that a grasping action which produces a significant movement is successful.}
...
\begin{table*}
    \centering
    \caption{Top sentences generated from the evidence \emph{\{\evidenceProducingBut\}}. The ``but'' conjunction was chosen in all of them. Intuitively, the model has learned that a grasping action which produces no movement is a failure.}
