...
\caption{Predictions about the action given the evidence $\xobs =\{\text{Size}=\text{small}, \text{Shape}=\text{sphere}, \text{ObjVel}=\text{slow}\}$, combined with different probabilistic soft evidence about the action.} % TODO change to "Inference over action...", to reflect the name of the subsection?
...
\caption{Predictions about the object velocity of different objects, when given probabilistic soft evidence about the action.} % TODO change to "Inference over the object velocity effect...", to reflect the name of the subsection?
...
\begin{figure*}
  ...
  \caption{Object velocity predictions before impact. The evidence from the action recognizer~(left) is fed into the \AffWords{} model before the end of the action. The combined model predicts the effect~(right) and describes it in words.} % TODO change to "Object velocity effect anticipation...", to reflect the name of the subsection?
