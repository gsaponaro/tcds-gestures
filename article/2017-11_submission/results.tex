...
% TODO: replace "evidence" with \xobs ?
\begin{equation*}
...
In the most likely sentence of the list~(in bold), we note how (i)~the correct action-related verb ``taps'' is generated, and (ii)~the object term ``ball'' is used twice, both in the first part and in the second part of the sentence.
...
\begin{table}
    \centering
    \caption{Sentences generated from the evidence $\{\text{Color=yellow, Size=big, Shape=circle, ObjVel=fast}\}$. The higher the score, the better.}
