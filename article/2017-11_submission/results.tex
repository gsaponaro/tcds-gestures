...
%    \centering
    ...
    In~(a) the model interprets the object movement as indicating a succesfull grasp and uses the conjunction ``and''.
    In~(b) the slow movement is interpreted as no movement at all, and, therefore, as an unsuccessfull grasp. The conjunction ``but'' is used consequently.}
