...
% We make our human action data and probabilistic reasoning code publicly available. % not necessary here?
...
As future work, we wish to investigate how the model can extract syntactic information from the observed data autonomously, thus relaxing the bag-of-word assumption in the current model.
...
% \item except for the gesture recognizer, the rest of our model has no time evolution $\rightarrow$ try dynamic Bayesian networks?
