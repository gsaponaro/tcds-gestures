...
It is reasonable to say that this skill is greatly facilitated, and influenced, by human language~(i.e., a highly elaborated, complex yet efficient communication system) TODO ADD REF.
...
The ability to understand and interpret our peers is related to the theory of mirror neurons which we brought up in Sec.~\ref{sec:intro}. 
