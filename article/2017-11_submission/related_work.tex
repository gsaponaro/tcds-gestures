...
Some authors have studied the ability to interpret under the deep learning paradigm.
...
In a recent work~\cite{saponaro:2017:glu} we have relaxed the assumption of knowing the action.
