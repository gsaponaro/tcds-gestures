...
\begin{figure*}
  \centering
  \subfloat[][Grasp: an agent~(human) moves the hand towards an object vertically, then grasps and lifts it.]{
  ...
  \subfloat[][Tap: an agent~(human) moves the hand towards an object laterally and touches it, causing a motion effect.]{
  ...
  \subfloat[][Touch: an agent~(human) moves the hand towards an object vertically, then touches it~(without grasping), then retracts the hand.]{
