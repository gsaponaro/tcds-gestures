...
\newcommand{\affword}{affordance--word}
...
Universidade de Lisboa, Lisbon, Portugal, e-mail: \{gsaponaro,rodrigo.ventura,alex\}@isr.tecnico.ulisboa.pt.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gsaponaro-tcds2017language-introduction}

TODO: ALSO CITE GLU~\cite{saponaro:2017:glu}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gsaponaro-tcds2017language-related_work}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gsaponaro-tcds2017language-approach}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gsaponaro-tcds2017language-results}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{gsaponaro-tcds2017language-conclusions}
