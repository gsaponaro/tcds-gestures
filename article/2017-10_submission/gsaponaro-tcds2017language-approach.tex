...
\begin{figure*}
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \begin{tikzpicture}
      % single nodes
      \node[affnode] (gestures) {Gesture Features};
      \node[affnode, right of=gestures] (f1) [right=1.2cm] {$f_1$};
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \node[group, fit=(e1) (e2) (edots),label=above:Effects] (effects) {};
      \node[group, fit=(w1) (w2) (wdots),label=above:Words] (words) {};
      \node[dashedgroup, fit=(actions) (features) (effects) (words),label={[shift={(0:2.2)}]above:Affordance model}]{};
      % arrows
      ...
      \draw[myarrow] (actions) -- (gestures);
      \node[dottedgrouptrapezium, trapezium angle=103, xshift=-21, fit=(actions) (gestures),label=above:Gesture/Action recognition]{};
    \end{tikzpicture}
