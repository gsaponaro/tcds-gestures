...
\end{itemize}
In the following sections we give details on the probabilistic models enclosed in Figure~\ref{fig:model} in the Affordance-word model and Gesture/Action recognition boxes, and finally on the way we combine evidence from the two models.
