...
Non-terminal symbols are given between \texttt{<.>} in italics, while words~(terminal symbols) are given in plain text and font: thus, the full set of words is given by the list of plain text words below.
