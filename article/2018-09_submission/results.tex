...
This experiment exposes that \emph{all} the variables of Fig.~\ref{fig:bnsymb} jointly link robot and human, not only the Action variable, for the reasons expressed in Sec.~\ref{sec:method}.
